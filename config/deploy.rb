...
set :repository,  "git@bitbucket.org:eltonokada/sharetribe.git"
...
set :deploy_to, "/var/www/sharegrid"
set :branch, ENV['BRANCH'] || "master"
set :server_name, "162.243.132.218"
set :host, "162.243.132.218"
set :deploy_to, "/var/www/sharegrid"
...
after "deploy:update_code" do
  ...
  run("cd #{release_path} && /usr/bin/env #{rake} i18n:write_error_pages RAILS_ENV=staging")
end
